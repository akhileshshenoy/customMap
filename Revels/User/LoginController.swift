...
class LoginController: UIViewController {
    ...
    @objc func openSignUpUrl(){
        let urlString = "https://register.mitrevels.in"
    ...
    @objc func dismissLogin(){
        self.userController?.showLoginItems()
        self.dismiss(animated: true, completion: nil)
    }
    ...
    func setupLoginRegisterButton() {
        ...
        continueAsGuestButton.heightAnchor.constraint(equalToConstant: 100).isActive = true
    }
