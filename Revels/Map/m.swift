...
//        btvc.attach(to: self)
//        btvc.yy.handleMapSearchDelegate = self
//        zoomMap(byFactor: 1)
//    }
//
...
//}
//
//extension m:CLLocationManagerDelegate
//{
...
////            btvc.yvc.imageView.image = UIImage(named:nam)
////              }
////              else {
////                btvc.yvc.imageView.image = UIImage(named:"SP")
////              }
...
////               }
//
////        if btvc.yvc.isLoaded == 0
////        {
////           // btvc.yvc.attach(to: self)
////            btvc.yvc.isLoaded = 1
////            btvc.yvc.name = nam
...
//    
//    func zoomToPlace(name:String, location: CLLocationCoordinate2D) {
//        btvc.yvc.isHidden = false
//        //btvc.view.bringSubviewToFront(btvc.yvc)
//        var nam = ""
//        nam = name
//        //btvc.changePosition(to: .bottom)
//         if currentPolylineOverlay.count != 0
...
////            btvc.yvc.imageView.image = UIImage(named:name)
////        }
////        else {
////          btvc.yvc.imageView.image = UIImage(named:"SP")
////        }
...
//    
//        btvc.setView(view: btvc.yvc, hidden: true)
//    }
//    
//    func showNavigation() {
